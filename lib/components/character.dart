...
class Character extends SpriteAnimationComponent with CollisionCallbacks, HasGameRef {
...
extension CreateAnimationByColumn on SpriteSheet {
  SpriteAnimation createAnimationByColumn({
    ...
    final spriteList = List<int>.generate(to - from, (i) => from + i).map((e) => getSprite(e, column)).toList();
